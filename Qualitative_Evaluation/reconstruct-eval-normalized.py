...
from bfm_reconstruction.datasets_normalized import NowDataset
...
models_path = '../camera-all-semi-supervised-bfm/outs/output*/*/*/supervised/*/*-normalized-*/*.pth'
...
denorm = True # true in case of superivised models
...
for model_path in sorted(glob.glob(models_path)):
    ...
    #         save_image(out_recon)
            save_image(face, f'{output_path_2d}/face{bix}.png', denorm=denorm)
